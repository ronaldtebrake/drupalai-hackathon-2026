...
Follow these steps to test the AI-powered content feedback feature:

1. **Install the website**
   - Complete the installation process using DDEV or your preferred local setup method.

2. **Configure AI integration**
   - Once installed, navigate to `/admin/config/ai/providers/amazeeio` and configure the AI integration following the [amazee.io AI provider setup](#amazeeio-ai-provider-setup) instructions above.

3. **Create an Article**
   - Go to `node/add/article`
   - Add an article with a title and description
   - Click **Save**

4. **AI Processing**
   - After saving, FlowDrop will automatically trigger the AI pipeline
   - The AI uses context from `drupal/ai_context` with guidelines from the [European Commission Web Writing Guidelines](https://commission.europa.eu/resources/europa-web-guide/design-content-and-development/content/web-writing-guidelines_en)
   - You can view these guidelines at `admin/config/ai/contexts`
   - The AI will analyze your content and provide feedback based on these guidelines

5. **View AI Feedback**
   - Once AI processing is complete, click the **Edit** button at the top right corner of the article page
   - The edit form will display the AI classification and feedback for the content you posted

Example of the AI feedback interface:

![AI Feedback Example](MissTraalScreenShot.png)
